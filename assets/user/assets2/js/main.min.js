! function(e) {
    ...
    var t = {
        ...
        mobileMenu: function() {
            e(".mmenu-btn").on("click", function(t) {
                var o = e(this).closest("li"),
                    i = o.find("ul").eq(0),
                    n = o.siblings(".open");
                n.find("ul").eq(0).slideUp(300, function() {
                    n.removeClass("open")
        ...
        owlCarousels: function() {
            ...
            })), e(".new-products").owlCarousel(e.extend(!0, {}, t, {
                margin: 30,
                autoplay: !1,
                responsive: {
                    0: {
            ...
            })), e(".blog-carousel").owlCarousel(e.extend(!0, {}, t, {
                loop: !1,
                margin: 30,
            ...
            o.click(function(i) {
                i.preventDefault(), e(this).text("Loading ..."), e.ajax({
                    ...
                    success: function(i) {
                        var n = e(i);
                        setTimeout(function() {
                            n.appendTo(".product-ajax-grid"), o.text("Load More"), ++t >= 2 && o.hide()
                        }, 350)
                    },
                    failure: function() {
        ...
        scrollToElement: function() {
            e('.scrolling-box a[href^="#"]').on("click", function(t) {
                ...
                o && "#" != o && e(o).length && (t.preventDefault(), e("html, body").stop().animate({
                    scrollTop: e(o).offset().top - 90
                }, 700))
            })
        },
        loginPopup: function() {
        ...
        modalView: function() {
            e(".btn-add-cart").click(function(o) {
