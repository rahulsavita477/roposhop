                           ...
                           <div class="product-details">
                              ...
                              <div class="product-filters-container">
                                 <ul>
                                    ...
                                    <li>15.24 cm (6.0 inch) FHD+ Display</li>
                                    <li>24MP + 5MP + 8MP | 24MP Front Camera</li>
                                    <li>3300 Lithium-ion Battery</li>
                                    <li>Octa Core Processor (2.2 GHz)</li>
                                    <li>Glass Design with Side Fingerprint Sensor</li>
                                 </ul>
                              </div>
                              <div class="price-box">
                  ...
                  <a href="details.php" style="columns:#000">
                     <div class="row">
                        ...
                        <div class="col-md-8 col-xs-12">
                           <div class="product-details">
                              <h2>Samsung Smart Plaza</h2>
                              <div class="product-filters-container">
                                 <strong>Address</strong><br>
                                 Merhant address
                                 142-143, REVENUE NAGAR, Annapurna Road, NEAR DUSSHERA MAIDAN, Indore, Madhya Pradesh, India - 452009 Shop no: 9152769319
                              </div>
                              <div class="row pt-2 pb-2">
                                 ...
                                 <div class="col-md-6 text-right">
                                    <button class="bs"><i class="fa fa-walking" aria-hidden="true"></i> 8.5</button>
                                 </div>
                              </div>
                           </div>
                        </div>
                  ...
                  <a href="details.php" style="columns:#000">
                     <div class="row">
                        <div class="col-md-4 col-xs-12 d-flex flex-column justify-content-center">
                           <figure class="">
                              <h2 style="color:blue">Pacific Marketing Ind.</h2>
                           </figure>
                        </div>
                        <div class="col-md-8 col-xs-12">
                           <div class="product-details">
                        ...
                        <div class="col-md-8 col-xs-12">
                           <div class="product-details">
                              ...
                              <div class="product-filters-container">
                                 ...
                                 The Consumer Electronics business division provides cable television, monitor, printer, air-conditioners, refrigerators, washing machines and medical devices. ... The company was founded on January 13, 1969 and is headquartered in Suwon, South Korea.
                              </div>
                           </div>
                        </div>
                     </div>
                ...
                <div class="sidebar-wrapper sticky-active" style="border-bottom: 0px none rgb(122, 125, 130); width: 270px;">
                    <div class="widget">
                        <h3 class="widget-title">
                            <a data-toggle="collapse" href="#widget-body-x" role="button" aria-expanded="true" aria-controls="widget-body-x">Filters</a>
                        </h3>
                                    ...
                                    <ul class="cd-filter-content cd-filters list">
                                        <li class="brand_filter">
                                            <input 
                                                ...
                                                checked
                                            />
                                            <label class="checkbox-label" for="checkbox1">Products</label>
                                        </li>
                                        <li class="brand_filter">
                                            <input 
                                                name="brand_filter"
                                                ...
                                                checked
                                            />
                                            <label class="checkbox-label" for="checkbox2">Categories</label>
                                        </li>
                                        <li class="brand_filter">
                                            <input 
                                                name="brand_filter"
                                                ...
                                                checked
                                            />
                                            <label class="checkbox-label" for="checkbox3">Brands</label>
                                        </li>
                                        <li class="brand_filter">
                                            <input 
                                                name="brand_filter"
                                                ...
                                                checked
                                            />
                                            <label class="checkbox-label" for="checkbox4">Sellers</label>
                                        </li>
                                        <li class="brand_filter">
                                            <input 
                                                name="brand_filter"
                                                ...
                                                checked
                                            />
                                            <label class="checkbox-label" for="checkbox5">Offers</label>
                                        </li>
                                    </ul>
                                </div>
                            </div>
