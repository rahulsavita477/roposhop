                            ...
                            <div class="widget-body">
                                <div class="filt">
                                    <ul class="cd-filter-content cd-filters list">
                                        <?php
                                        foreach ($listing_product_categories as $key => $category) 
                                        {
                        ...
                        <div class="collapse show" id="widget-body-z">
                            <div class="widget-body">
                                <div class="filt">
                                    <ul class="cd-filter-content cd-filters list">
                                        <?php
                                        foreach ($listing_product_brands as $key => $brand) 
                                        {
...
function getAndSetProductListing(page) 
{
    ...
    $.when(getMerchantProducts("<?= $_GET['merchant_id'] ?>", page)).done(function(merchantProducts){        
        ...
        if (resp.listings == null || resp.listings == 'undefined') 
        {
            ...
            setMerchantProductData(resp.listings, resp.paging);
    });
}

//set merchant product data in product boxes
async function setMerchantProductData(listing_products, paging) 
{
