            ...
            <div class="container">
                <ol class="breadcrumb mt-0 mb-2">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0)"
                            class="text-active"><?= $brand['name'] ?></a></li>
                </ol>
                    ...
                    <div class="row">
                        <div class="col-lg-5 product-single-gallery">
                            <div class="sticky-slider">
                                ...
                                <div
                                    style="display:flex;align-items:center;justify-content:center;height:90px;max-width:200px;background:#007BFF;border-radius:8px;text-decoration:none;padding:5px 15px;box-sizing:border-box;">
                                    <span
                                        style="color:#fff;margin:0;font-size:14px;font-weight:600;text-align:center;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">
                                        <?= $brand['name'] ?>
                                    </span>
                                </div>
                                <?php endif; ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <form method="get" action="javascript:void(0)" class="form-inline">
                            ...
                            <button type="button" class="btn-primaryss" onclick="getAndSetBrandProducts(1)"> <i
                    ...
                    <div class="sidebar-wrapper sticky-active"
                        ...
                        <div class="widget">
                            <h3 class="widget-title">
                                <a data-toggle="collapse" href="#widget-body-y" aria-expanded="true"
                                    aria-controls="widget-body-y">Categories</a>
                            </h3>
    ...
    async function setBrandProductData(listing_products, paging) {
        ...
        for (var i = 1; i <= paging.total_pages; i++) {
            ...
            pagination_li += '<li class="page-item ' + active_class +
                '"><a class="page-link" href="javascript:void(0)" onclick="getAndSetBrandProducts(' + i + ')">' +
                i + '</a></li>';
        }
        ...
        for (var i = 0, j = 1; i < listing_products.length; i++) {
            ...
            if (listing_products[i].listing_id) { // set product-listing href link
                ...
                $("#listing_product_url" + k).attr("href",
                    "<?= base_url('listings/'.url_title('establishment_name', '-', true).'?') ?>" + 'list_id=' +
                    listing_products[i].listing_id + '&prd_id=' + listing_products[i].product_id);
            ...
            $.when(getProduct(listing_products[i].product_id)).done(function(product) {
                ...
                if (resp.product.offer_price > 0) $("#listing" + j + "_price").html(resp.product
                    .offer_price);
