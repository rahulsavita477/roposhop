        ...
        <main class="main">
            <div class="container">
                <ol class="breadcrumb mt-0 mb-2">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0)" class="text-active"><?= $category_name ?></a></li>
                </ol>

                <div class="row">
                    <aside class="sidebar-shop col-12 col-lg-3 order-lg-0">
                        <div class="pin-wrapper" style="height: 1404px;">
                            <div class="sidebar-wrapper sticky-active">
                                <div class="row">
                                    <div class="col-6 col-lg-12">
                                        <div class="widget">
                                            <h3 class="widget-title">
                                                <a data-toggle="collapse" href="#widget-body-z" role="button"
                                                    aria-expanded="true" aria-controls="widget-body-z"><i class="icon-sliders"></i> Brand</a>
                                            </h3>
                                            <div class="collapse" id="widget-body-z">
                                                <div class="widget-body">
                                                    <div class="filt">
                                                        <ul class="cd-filter-content cd-filters list">
                                                            <?php foreach ($brands['result'] as $key => $brand) {

                                                                echo '<li class="brand_filter">
                                                                    <input name="brand_filter" class="filter" 
                                    ...
                                    <?php if ($a_child_category[0] != $parent_category_id) { ?>
                                    <div class="col-6 col-lg-12">
                                        <div class="widget">
                                            <h3 class="widget-title">
                                                <a data-toggle="collapse" href="#widget-body-y" role="button"
                                                    aria-expanded="true" aria-controls="widget-body-y"><i class="icon-sliders"></i> Category</a>
                                            </h3>
                                            <div class="collapse" id="widget-body-y">
                                                <div class="widget-body">
                                                    <div class="filt">
                                                        <ul class="cd-filter-content cd-filters list">
                                                            <?php foreach ($tree_list as $parent_category) {

                                                                if ($parent_category['category_id'] != $parent_category_id) {
                                                                    continue;
                                                                }

                                                                foreach ($parent_category['child_category'] as $key => $category) {
                    ...
                    <div class="col-12 col-lg-9 order-lg-1">
                        ...
                        <div class="row">
                            ...
                            for ($i=1; $i <=$n_totalProduct; $i++) {
                                ...
                                echo '<div class="col-6 col-md-3 pl-1 pr-1 mb-1">
                                    <div class="product-default w-set">
                                        <a id="product_url'.$i.'">
                                            ...
                                            <figure>
                                                <img style="height: 150px; object-fit: scale-down;" id="product'.$i.'_img" />
                                            </figure>
                                            <div class="product-details text-left">
                                                <h2 class="product-title text-black">
                                                    <span id="product'.$i.'_name"></span><br>
                                                    <span class="color-change">
                                                        <strike id="product'.$i.'_price_div">₹<span id="product'.$i.'_price">&nbsp;</strike> ₹<span id="listing'.$i.'_price"></span>
                                                    </span>
            ...
            async function setProductData(products, paging) {
                ...
                for (var i = 1; i <= paging.total_pages; i++) {
                    ...
                    pagination_li += '<li class="page-item ' + active_class +
                        '"><a class="page-link" href="javascript:void(0)" onclick="getAndSetProductListing(' + i +
                        ')">' + i + '</a></li>';
                }
                ...
                for (var i = 0, j = 1; i < products.length; i++) {
                    ...
                    let k = i + 1;
                    let productURL = "<?= base_url('products/') ?>" + url_title(products[i].product_name) +
                        '?prd_id=' + products[i].product_id;
                    ...
                    $.when(getProduct(products[i].product_id)).done(function(product) {
                        ...
                        if (resp.product.discount_price > 0) {
                            ...
                            $("#product" + j + "_price_div").remove();
                            $("#product" + j + "_discount_div").remove();
                        }
