...
<body id="page-home">
    <div class="page-wrapper">
        ...
        <main class="main">
                       ...
                       <div class="container">
                           ...
                           <div class="row pb-10">
                                <div class="col-md-6 col-md-6">
                                    <img class="left-imgsection" src="assets/images/banners/testing2.jpeg" style="height:320px;width:auto;">
                                </div>    
                                <div class="col-6 col-md-6 text-center slide-content-right">
                                    <div class="home-slide-content">
                                         <div class="slide-border-top">
                                    <img src="assets/images/slider/border-top.png" alt="Border" width="290" height="38">
                                </div>
                                        
                                        <h1 class="mt-5">Celebrate Diwali With MI</h1>
                                        <a href="#" class="btn btn-primary">Now More</a>
                                         <div class="slide-border-bottom">
                                    <img src="assets/images/slider/border-bottom.png" alt="Border" width="290" height="111">
                                </div>
                                    </div>
                            ...
                            <div class="row pb-10">
                                ...
                                <div class="col-6 col-md-6 text-center slide-content-right">
                                    ...
                                    <img src="assets/images/slider/border-top.png" alt="Border" width="290" height="38">
                                        ...
                                        <h1 class="mt-5">Samsung Galaxy Smart Phone in 6 Easy EMI</h1>
                                        <a href="#" class="btn btn-primary">Now More</a>
                                         <div class="slide-border-bottom">
                                    <img src="assets/images/slider/border-bottom.png" alt="Border" width="290" height="111">
                                </div>
            ...
            <div class="info-boxes-container mb-0">
                <div class="container">
                    <div class="info-box">
             ...
             <div class="featured-products-section carousel-section pt-0">
              <!--<h2 class="h3 title float-left">SMART PHONES</h2>
                   ...
                   <hr class="sethr" style=" margin:0px 0px 20px 0px"> -->
                     ...
                     <div id="singal-slider" class="new-products owl-carousel owl-theme"  data-toggle="owl" data-owl-options="{
                        ...
                        <div class="product-default" style="width:100%;margin: 0px">
                           <a href="#">
                            <div class="row bg-info ml-0 mr-0">
                              <div class="col-md-6 col-6 pl-0 pr-0">
                                <img src="assets/images/banners/testing2.jpeg" alt="product" style="height:300px; width: auto;padding:2px">
                              </div>  

                               <div class="col-md-6 col-6 text-left">
                                <h1 class="text-left pt-5 text-white">
                                    <span class="float-left pt-5 pr-5 text-uppercase">Samsung Galaxy Smart Phone in 6 Easy EMI </span> <!-- <img src="assets/images/brands/infi.png" style="width: auto; height: 30px"> -->
                           ...
                           <div id="two-slider" class="new-products owl-carousel owl-theme"  data-toggle="owl" data-owl-options="{
                        'margin': 20,
                         'loop': false,
                        'autoplayHoverPause' : true,
                         'dots':false,
                        ...
                        <div class="product-default">
                           <a href="#">
                            <div class="row bg-info ml-0 mr-0">
                              <div class="col-md-12 col-12 pl-0 pr-0 img-bo">
                                <img src="assets/images/banners/testing2.jpeg" alt="product" style="height:300px; width: auto; padding:2px">
                              </div>  
                                 <div class="overlay">
                                  <span class="text-uppercase">Samsung Galaxy Smart Phone in 6 Easy EMI </span>                               
                                 </div>
                            </div>    
                           </a>
                       </div>
                       ...
                       <div class="product-default">
                           <a href="#">
                            <div class="row bg-info ml-0 mr-0">
                              <div class="col-md-12 col-12 pl-0 pr-0 img-bo">
                                <img src="assets/images/banners/testing1.jpeg" alt="product" style="height:300px; width: auto; padding:2px">
                              </div>  
                                 <div class="overlay">
                                  <span class="text-uppercase">Samsung Galaxy Smart Phone in 6 Easy EMI </span>                               
                                 </div>
                          ...
                          <div id="three-slider" class="new-products owl-carousel owl-theme"  data-toggle="owl" data-owl-options="{
                        'margin': 20,
                         'loop': false,
                        'autoplayHoverPause' : true,
                         'dots':false,
    ...
    background-size: cover;">
                 <div class="row">
                   ...
                   <div class="banner-content">
                     <h3 class="mb-0">Samsung Galaxy</h3>
             ...
             <div class="partners-container pt-1 pb-1 ">
                <div class="container">
                    <div class="partners-carousel  owl-carousel owl-theme min-123" data-toggle="owl" data-owl-options="{
                       ...
                       <a href="#" class="partner d-flex flex-column justify-content-center" style="width:auto;height:90px;max-height:90px;max-width:200px;background:#08c;">
                           <h3 class="d-flex flex-column justify-content-center" style="color:#fff">Oppo fsdfdfdfdfdfd</h3>
                        </a>
                        <a href="#" class="partner" style="width:auto;height:90px;max-height:90px;max-width:200px;">
             ...
             <div class="partners-container pt-1 pb-1 ">
                <div class="container">
                    <div class="partners-carousel  owl-carousel owl-theme min-123" data-toggle="owl" data-owl-options="{
                       ...
                       <a href="#" class="partner d-flex flex-column justify-content-center" style="width:auto;height:90px;max-height:90px;max-width:200px;background:red;">
                           <h3 class="d-flex flex-column justify-content-center" style="color:#fff">Kamal Shop dfgfg fgfg  rtrtrtertr rt rtr</h3>
                        </a>
                        <a href="#" class="partner d-flex flex-column justify-content-center" style="width:auto;height:90px;max-height:90px;max-width:200px;background:#000;">
                           <h3 class="d-flex flex-column justify-content-center" style="color:#fff">Kamal Shop</h3>
                        </a>

                        <a href="#" class="partner d-flex flex-column justify-content-center" style="width:auto;height:90px;max-height:90px;max-width:200px;background:green;">
                           <h3 class="d-flex flex-column justify-content-center" style="color:#fff">Pacific Marketing Ind. (BenQ Authorised Showroom)</h3>
                        </a>

                        <a href="#" class="partner d-flex flex-column justify-content-center" style="width:auto;height:90px;max-height:90px;max-width:200px;">
                            <img class="d-flex flex-column justify-content-center" src="assets/images/merchants/7.jpeg" alt="" >
                        </a>
                        <a href="#" class="partner" style="width:auto;height:90px;max-height:90px;max-width:200px;">
                            <img src="assets/images/merchants/imgpsh_fullsize_anim.jpg" alt="" >
                        </a>
