              ...
              <nav aria-label="breadcrumb" class="breadcrumb-nav">
                <div class="container">
                    <ol class="breadcrumb mt-0">
                        ...
                        <li class="breadcrumb-item"><a href="#" class="text-active">Reset Password</a></li>
                    </ol>
                </div><!-- End .container -->
            </nav>
               ...
               <div class="row row-sm">
                ...
                <div class="col-md-6  pt-5 pb-5 pl-5 pr-5 mx-auto">
                  ...
                  <div class="text-center pb-2 mt-1"><h3>Reset Password</h3></div>
                  <p class="pl-3">Please enter your email address below to receive a password reset link.</p>
